    ...
    <>
      ...
      <FeatureSection grayer center>
        <Text center>
          ...
          <Details>Connect with peers and access everything you need right on campus.</Details>
        </Text>
        <FeatureDemo
      ...
      <FeatureSection right>
        <Text>
          <Title size="md">
            <GradientText className="pink-blue">Just right</GradientText>
            <br />  in seconds.
          </Title>
          <Details>Find what you need or post listings in just a few clicks.</Details>
        </Text>
        <FeatureDemo
      ...
      <FeatureSection grayer>
        <Text>
          <Title size="md">
            <GradientText className="green-sky">A Seamless Experience.</GradientText>
            <br />
          </Title>
          <Details>
            Search, filter, and explore the Collegium marketplace effortlessly.
          </Details>
        </Text>
        <FeatureDemo
