  ...
  return (
    <Section grayer className="gap-24 text-center">
      ...
      <div className="gap-4 col">
        <Title size="md">
          What are the <GradientText className="amber-red">Students</GradientText> Saying?
        </Title>
        <Details>
  We’re just getting started! Be among the first to share your experience with <GradientText className="amber-red">Collegium</GradientText>.
</Details>
      </div>
      {/* Testimonials */}
